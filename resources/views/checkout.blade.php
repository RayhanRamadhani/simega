...
<div class="container">
    ...
    <div class="flex items-center gap-x-4 justify-end w-full">
        ...
        <button type="submit" class="relative inline-flex items-center justify-center px-6 py-2 font-bold bg-gradient-to-r from-pink-500 to-blue-500 text-transparent bg-clip-text border border-blue-500 rounded-md hover:opacity-90">
            Lanjut
        </button>
    </div>
</div>
