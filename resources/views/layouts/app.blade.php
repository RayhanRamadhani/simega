            ...
            <nav class="mt-5 text-base font-semibold">
                <ul>
                    ...
                    <li class="p-3"><a href="#" class="inline-flex items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                      ...
                      Prioritas</a></li>
                    <li class="p-3"><a href="{{ route("task") }}" class="bg-blue-200 px-6 py-1 rounded-full hover:bg-blue-300 transition inline-flex items-center w-fit"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
